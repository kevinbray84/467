...
foyer_keys.set_description(
    "Hanging from peg are a set of what appear to be car keys. The logo on the keychain is BMW.")
...
side_table.set_description(
    "You approach the side table and take a closer look at the yellow object \nthat caught your eye. It is a flashlight. This could come in handy later.")
